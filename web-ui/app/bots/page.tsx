...
type Order = { id: number; action: string; qty: number; status: string; failure_category: string | null; fail_reason?: string | null; latency_ms: number; created_at?: string | null; executed_at?: string | null };
