...
export default function StrategyDetailPage() {
  ...
  // ★ 一键跟单（弹窗逻辑抽到共享 FollowModal，与策略广场完全一致）
  ...
  return (
    <main style={{ minHeight: "100vh", position: "relative" }}>
      ...
      {/* ★ 跟单弹窗（与策略广场共用 FollowModal，设置完全一致） */}
      <FollowModal
        strategy={followOpen && detail ? { id: detail.id, display_name: detail.display_name, style: detail.style, max_drawdown: detail.max_drawdown } : null}
